 ...
 *
 * @return SmartScaleParams object with translateX and translateY params
 */
export function getScalingOffsetTranslations(originRect: DOMRect, destRect: DOMRect): SmartScaleParams {
 ...
 *
 * @return SmartScaleParams object with scale param
 */
export function getScaleToFitContainerParam(rect: DOMRect, container: DOMRect): SmartScaleParams {
