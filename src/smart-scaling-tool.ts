import { getScaleToFitContainerParam, scaleRectangle } from "./scale-utils";
import { getTranslateIntoContainerParams } from "./translate-utils";
import { SmartScaleParams } from "./smart-scale-params";
 ...
 *
 * @returns SmartScaleParams object with scale, translateX, and translateY properties
 */
 ...
 *
 * @returns SmartScaleParams object with scale, translateX, translateY, and complete() params
 */
export function getSmartUnscaleParams(originTrackingId: string = ""): SmartScaleParams {
  return {
    scale: 1,
    translateX: 0,
    translateY: 0,
